...
class PDF extends FPDF
{
    ...
    function CustomerOrderInformation($customerKeys, $customerInformation, $orderKeys, $orderInformation)
    {
           ...
           $this->SetY(69);
           $this->SetX(10);
           $this->Cell(90, 5, 'Kundeoplysninger', 1, 0, 'L');
           $this->Cell(90, 5, 'Bestillingsoplysninger', 1, 1, 'L');

           $this->SetFont('Arial','',9);
           $this->SetY(74);
           $this->SetX(10);

           $this->Multicell(20,5,$customerKeys, 0, 'L');

           $this->SetY(74);
           $this->SetX(30);

           $this->MultiCell(60,5,$customerInformation,0,'L');   

           $this->SetY(74);
           $this->SetX(100);

           $this->MultiCell(20,5,$orderKeys,0,'L');   

           $this->SetY(74);
           $this->SetX(120);

           $this->MultiCell(70,5,$orderInformation,0,'L');   

           $this->Line(10,69,10,105);
           $this->Line(100,69,100,105);
           $this->Line(190,69,190,105);

           $this->Line(10,105,190,105); // nederste horisontale linie
    }
    ...
    function OrderLines($orders, $shipping, $total, $vatTotal)
    {
            ...
            $this->Cell(65, 5, 'Betegnelse', 1, 0, 'L');
            $this->Cell(15, 5, iconv("UTF-8", "ISO-8859-1","Beløb"), 1, 0, 'R');
            $this->Cell(15, 5, 'Antal', 1, 0, 'R');
            $this->Cell(60, 5, iconv("UTF-8", "ISO-8859-1","Total beløb"), 1, 1, 'R');
...
//            $this->Cell(25, 5, 'Varenummer', 1, 0, 'L');
//            $this->Cell(65, 5, 'Betegnelse', 1, 0, 'L');
//            $this->Cell(15, 5, iconv("UTF-8", "ISO-8859-1","Beløb"), 1, 0, 'L');
//            $this->Cell(15, 5, 'Antal', 1, 0, 'L');
//            $this->Cell(60, 5, iconv("UTF-8", "ISO-8859-1","Total beløb"), 1, 1, 'R');
         ...
         $this->SetY(111);
         $this->SetX(35);
         $this->MultiCell(65,5,$product_name,'LT','L');  

         $this->SetY(111);
         $this->SetX(100);
         $this->MultiCell(15,5,$prices,'LT','R');  

         $this->SetY(111);
         $this->SetX(115);    
         $this->MultiCell(15,5,$product_quantitys,'LRT','R');

         $this->SetY(111);
         $this->SetX(130);     
         $this->MultiCell(60,5,$rowprices,1,'R');

         //Subtotal
         $this->SetX(10);
         //$this->SetFont('Arial','',9);
         $this->Cell(90, 5, 'Subtotal', 1, 0, 'L');
         $this->Cell(90, 5, $subtotal." kr.", 1, 1, 'R');
         
         //Shipping
         $this->SetX(10);
         //$this->SetFont('Arial','',9);
         $this->Cell(90, 5, iconv("UTF-8", "ISO-8859-1","Forsendelse og håndtering"), 1, 0, 'L');
         $this->Cell(90, 5, $shipping." kr.", 1, 1, 'R');
         ...
         $this->SetX(10);
         //$this->SetFont('Arial','',9);
         $this->Cell(90, 5, iconv("UTF-8", "ISO-8859-1","Total beløb"), 1, 0, 'L');
         $this->Cell(90, 5, $total." kr.", 1, 1, 'R');
         
         //VAT
         $this->SetFont('Arial','I',9);
         $this->SetX(10);
         $this->Cell(90, 5, "Heraf moms", 1, 0, 'L');
         $this->Cell(90, 5, $vatTotal." kr.", 1, 1, 'R');
