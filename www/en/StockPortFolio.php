...
//$graph->title->Set("Last attempt to fetch: " . $lastFetchTime . " # Data last stored: " . $lastDataStored . " # Data first stored: " . $firstDataStored . "\nStock portfolio for stock " . $stockName . " # " . $stockCode . " # " . $stockNumbers . " * " . round($stockRate, 2) . " = " . round($stockNumbers * $stockRate)  . "\n # Day: " . $dayResult . "(" . $dayResultProcent . "%)" . " # Week: " . $weekResult  . "(" . $weekResultProcent . "%)" . " # Month: " . $monthResult  . "(" . $monthResultProcent . "%)" . " # Year: " . $yearResult . "(" . $yearResultProcent . "%)"   );  
$graph->title->Set("Stock portfolio for stock " . $stockName . " # " . $stockCode . " # " . $stockNumbers . " * " . round($stockRate, 2) . " = " . round($stockNumbers * $stockRate));  
if ($dayResult < 0)	
{
...
$graph->subtitle->Set("Day: " . $dayResult . "(" . $dayResultProcent . "%)" . " # Week: " . $weekResult  . "(" . $weekResultProcent . "%)" . " # Month: " . $monthResult  . "(" . $monthResultProcent . "%)" . " # Year: " . $yearResult . "(" . $yearResultProcent . "%)" . " # Lifespan: " . $fromStartResult . "(" . $fromStartResultProcent . "%)" . " # Min: " . $minValue . "  # Max: " . $maxValue . " # Max-Min: " . $minMaxDifference);
$graph->subsubtitle->Set("Last attempt to fetch: " . $lastFetchTime . " # Data last stored: " . $lastDataStored . " # Data first stored: " . $firstDataStored);



$graph->xaxis->title->Set('Stock date');  
$graph->xaxis->SetTickLabels($x_axis);  
$graph->xaxis->SetLabelAngle(50);
$graph->xaxis->SetTextLabelInterval(5);
$graph->yaxis->title->Set('Actual value'); 
