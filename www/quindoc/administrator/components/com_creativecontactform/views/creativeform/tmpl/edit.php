...
foreach($this->form->getFieldset() as $field): ?>
			...
			<?php 
				...
				echo $field->input;
				if($qq == 8) {?>
					<a style="float: left;margin-top: 7px;clear:both;" href="http://creative-solutions.net/joomla/creative-contact-form/demo" target="_blank">See Templates Demo</a>
				<?php }
			?>
			</li>
<?php $qq ++;
					...
					<div class="tab-pane active" id="details">
						<div class="control-group">
							...
							foreach($this->form->getFieldset() as $field): ?>
								...
								<?php if($qq == 9) {?>
									<a href="http://creative-solutions.net/joomla/creative-contact-form/demo" target="_blank">See Templates Demo</a>
								<?php }?>
								</div>
