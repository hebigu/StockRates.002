...
(function($){
	...
	var GDatetimepicker = function(elem, params){
		...
		this.shortDaysIndexes = $(this.element).data('shortDaysIndexes') ? $(this.element).data('shortDaysIndexes') : $.gdatetimepicker.shortDaysIndexes;
	...
	GDatetimepicker.prototype = {
		...
		build_days_panel: function (current_date){
			...
			var prev_days_counter = picker.get_month_length(current_date.getFullYear(), current_date.getMonth() - 1) - first_day + 1;
