...
namespace StockRates._003.DLL
{
    public static class SqlBuilder
    {
        ...
        public static string GetBatchNumbers()
        {
            string sql = "SELECT DISTINCT BatchNo FROM StockRates.StockRatesInventory ORDER BY BatchNo";
        ...
        public static string GetUpdateStatementForControl(bool inUse)
        {
            string sql = "UPDATE StockRates.Control SET InUse = " + Convert.ToInt16(inUse);
        ...
        public static string GetLastInsertedStocks(string stockCode, int take = 2)
        {
            return
                "SELECT Rate * CurrencyRate AS RateCurrencyRate FROM StockRates.StockRatesInventory AS StockRatesInventory " +
                "WHERE StockRatesInventory.StockCode = '" + stockCode + "' " +
